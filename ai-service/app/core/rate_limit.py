...
async def rate_limit(
    ...
    try:
        redis = get_redis()
        window = window or settings.RATE_LIMIT_CHAT_WINDOW
        max_req = max_requests or settings.RATE_LIMIT_CHAT_MAX
        ...
        logger.warning("Redis rate limit bypass", error=str(e))
