...
const INITIAL_HOMEWORK: HomeworkTask[] = [
  {
    ...
    title: "Implement a Fibonacci Calculator function",
    description: "Write a Python function `fibonacci(n)` that returns the n-th Fibonacci number using recursion or iteration.",
    estimatedMinutes: 20,
    completed: false,
    dueDate: "Tomorrow",
  },
  {
    id: "hw-2",
    topic: "React Hooks",
    title: "Refactor class component to useEffect hook",
    description: "Convert a standard data-fetching Lifecycle component into a clean functional component using `useEffect`.",
    estimatedMinutes: 30,
    completed: true,
    dueDate: "Done",
  },
  {
    id: "hw-3",
    topic: "SQL Joins",
    title: "Write an INNER JOIN query for Order & Customer tables",
    description: "Construct a query retrieving total expenditure per customer name across two relational tables.",
    estimatedMinutes: 15,
    completed: false,
    dueDate: "In 3 days",
  },
